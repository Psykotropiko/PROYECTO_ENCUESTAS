 ...
 * @author luis
 */
@WebServlet(name = "ServletRedireccionarPreguntas", urlPatterns = {"/ServletRedireccionarPreguntas"})
public class ServletRedireccionarPreguntas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("listadoPreguntas_1.jsp");
