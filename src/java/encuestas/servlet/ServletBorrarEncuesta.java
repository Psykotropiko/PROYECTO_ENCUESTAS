 ...
 * @author luis
 */
@WebServlet(name = "ServletBorrarEncuesta", urlPatterns = {"/ServletBorrarEncuesta"})
public class ServletBorrarEncuesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Encuesta encuesta = this.encuestaFacade.find(new Integer("1"));
        
        List<Encuesta> encuestas = (List)sesion.getAttribute("encuestas");
