 ...
 * @author luis
 */
@WebServlet(name = "ServletEditarEncuesta", urlPatterns = {"/ServletEditarEncuesta"})
public class ServletEditarEncuesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        encuesta.setNombre(request.getParameter("nombre"));
        encuesta.setDescripcion(request.getParameter("descripcion"));
