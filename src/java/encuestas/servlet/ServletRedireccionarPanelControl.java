 ...
 * @author luis
 */
@WebServlet(name = "ServletRedireccionarPanelControl", urlPatterns = {"/ServletRedireccionarPanelControl"})
public class ServletRedireccionarPanelControl extends HttpServlet {
