 ...
 * @author luis
 */
@WebServlet(name = "ServletRedireccionarModificarEncuesta", urlPatterns = {"/ServletRedireccionarModificarEncuesta"})
public class ServletRedireccionarModificarEncuesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Encuesta> lista = usuario.getEncuestaList();
